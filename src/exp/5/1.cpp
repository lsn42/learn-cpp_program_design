...
class Boat: virtual public Vehicle //补充类定义的相应代码
{
 public:
  ...
  void ShowMe() { cout << "I'm boat！" << endl; }
...
class AmphibianCar:
  virtual public Car,
  virtual public Boat //补充类定义的相应代码
{
 public:
  AmphibianCar(int weight, float aird, float tonnage):
    Vehicle(weight), Car(weight, aird), Boat(weight, tonnage)
  {
    cout << "载入AmphibianCar类对象构造成功！" << endl;
  }
  void ShowMe() { cout << "I‘m amphibianCar！" << endl; }
  void ShowMembers()
  {
    cout << "重量：" << weight << "顿，"
         << "空气排量：" << aird << "CC，"
